...
class PawDrawEditorProvider {
    ...
    static register(context) {
        return vscode.window.registerCustomEditorProvider2(PawDrawEditorProvider.viewType, new PawDrawEditorProvider(context), {
    ...
    getHtmlForWebview(webview) {
        ...
        const styleUri = webview.asWebviewUri(vscode.Uri.file(path.join(this._context.extensionPath, 'media', 'pawDraw.css')));
